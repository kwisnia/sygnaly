...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.w1UpperPlotWidget = PlotWidget(570, 270)
        self.w1LowerPlotWidget = PlotWidget(570, 270)
        self.w2UpperPlotWidget = PlotWidget(570, 270)
        self.w2LowerPlotWidget = PlotWidget(570, 270)
