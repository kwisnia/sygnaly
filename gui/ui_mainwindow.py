...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.wspolczynnikWypelnieniaSkokuLabel_11.setObjectName(u"wspolczynnikWypelnieniaSkokuLabel_11")

        self.szumImpulsowyLayout.setWidget(3, QFormLayout.LabelRole, self.wspolczynnikWypelnieniaSkokuLabel_11)
        ...
        self.filtrDolnoprzepustowyLayout.setWidget(3, QFormLayout.LabelRole, self.typOknaLabel)
        ...
        self.filtrDolnoprzepustowyLayout.setWidget(3, QFormLayout.FieldRole, self.typOknaComboBox)
        ...
        self.filtrGornoprzepustowyLayout.setWidget(3, QFormLayout.LabelRole, self.typOknaLabel_2)
        ...
        self.filtrGornoprzepustowyLayout.setWidget(3, QFormLayout.FieldRole, self.typOknaComboBox_2)
        ...
        self.dzialaniaDwuLayout.setWidget(0, QFormLayout.LabelRole, self.operacjaDwuLabel)
        ...
        self.dzialaniaDwuLayout.setWidget(0, QFormLayout.FieldRole, self.operacjaDwuComboBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.generujPrawy.setText(QCoreApplication.translate("MainWindow", u"generuj lewy", None))
        self.generujLewy.setText(QCoreApplication.translate("MainWindow", u"generuj prawy", None))
        ...
        self.wspolczynnikWypelnieniaSkokuLabel_11.setText(QCoreApplication.translate("MainWindow", u"Prawdopodobienstwo skoku", None))
        ...
        self.typOknaLabel.setText(QCoreApplication.translate("MainWindow", u"Typ okna", None))
        self.typOknaComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"prostokatny", None))
        self.typOknaComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Blackmana", None))
        ...
        self.typOknaLabel_2.setText(QCoreApplication.translate("MainWindow", u"Typ okna", None))
        self.typOknaComboBox_2.setItemText(0, QCoreApplication.translate("MainWindow", u"prostokatny", None))
        self.typOknaComboBox_2.setItemText(1, QCoreApplication.translate("MainWindow", u"Blackmana", None))
        ...
        self.dzialaniaTab.setTabText(self.dzialaniaTab.indexOf(self.dzialaniaDwSygnaloweTab), QCoreApplication.translate("MainWindow", u"dwu-sygnalowe", None))
    # retranslateUi
